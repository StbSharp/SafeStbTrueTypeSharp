...
namespace StbTrueTypeSharp
{
	partial class StbTrueType
	{
		...
		public static int stbtt_InitFont_internal(stbtt_fontinfo info, byte[] data, int fontstart)
		{
			...
			int i = 0;
			int numTables = 0;
			FakePtr<byte> ptr = new FakePtr<byte>(data);
			info.data = ptr;
			info.fontstart = (int)(fontstart);
			info.cff = (stbtt__buf)(stbtt__new_buf(FakePtr<byte>.Null, (ulong)(0)));
			cmap = (uint)(stbtt__find_table(ptr, (uint)(fontstart), "cmap"));
			...
			else
			{
				...
				uint cff = 0;
				cff = (uint)(stbtt__find_table(ptr, (uint)(fontstart), "CFF "));
				if (cff == 0)
					return (int)(0);
				info.fontdicts = (stbtt__buf)(stbtt__new_buf(FakePtr<byte>.Null, (ulong)(0)));
				info.fdselect = (stbtt__buf)(stbtt__new_buf(FakePtr<byte>.Null, (ulong)(0)));
				info.cff = (stbtt__buf)(stbtt__new_buf(new FakePtr<byte>(ptr, (int)cff), (ulong)(512 * 1024 * 1024)));
				...
				stbtt__dict_get_ints(topdict, (int)(17), out charstrings);
				stbtt__dict_get_ints(topdict, (int)(0x100 | 6), out cstype);
				stbtt__dict_get_ints(topdict, (int)(0x100 | 36), out fdarrayoff);
				stbtt__dict_get_ints(topdict, (int)(0x100 | 37), out fdselectoff);
			...
			t = (uint)(stbtt__find_table(ptr, (uint)(fontstart), "maxp"));
			if ((t) != 0)
				info.numGlyphs = (int)(ttUSHORT(ptr + t + 4));
			else
				info.numGlyphs = (int)(0xffff);
			info.svg = (int)(-1);
			numTables = (int)(ttUSHORT(ptr + cmap + 2));
			...
			if ((info.index_map) == (0))
				return (int)(0);
			info.indexToLocFormat = (int)(ttUSHORT(ptr + info.head + 50));
			return (int)(1);
		}
		...
		public static int stbtt_GetCodepointShape(stbtt_fontinfo info, int unicode_codepoint, out stbtt_vertex[] vertices)
		{
			return (int)(stbtt_GetGlyphShape(info, (int)(stbtt_FindGlyphIndex(info, (int)(unicode_codepoint))), out vertices));
		}
		...
		public static int stbtt_GetGlyphBox(stbtt_fontinfo info, int glyph_index, ref int x0, ref int y0, ref int x1, ref int y1)
		{
			if ((info.cff.size) != 0)
			{
				stbtt__GetGlyphInfoT2(info, (int)(glyph_index), ref x0, ref y0, ref x1, ref y1);
			}
			else
			{
		...
		{
			return (int)(stbtt_GetGlyphBox(info, (int)(stbtt_FindGlyphIndex(info, (int)(codepoint))), ref x0, ref y0, ref x1, ref y1));
		}
		...
		public static int stbtt_IsGlyphEmpty(stbtt_fontinfo info, int glyph_index)
		{
			...
			if ((info.cff.size) != 0)
				return (int)((stbtt__GetGlyphInfoT2(info, (int)(glyph_index), ref x0, ref y0, ref x1, ref y1)) == (0) ? 1 : 0);
		...
		public static int stbtt__GetGlyphShapeTT(stbtt_fontinfo info, int glyph_index, out stbtt_vertex[] pvertices)
		{
			...
			if ((numberOfContours) > (0))
			{
				...
				for (i = (int)(0); (i) < (n); ++i)
				{
					if ((flagcount) == (0))
					{
						flags = (byte)(points.GetAndIncrease());
						if ((flags & 8) != 0)
							flagcount = (byte)(points.GetAndIncrease());
					}
					else
						--flagcount;
				...
				for (i = (int)(0); (i) < (n); ++i)
				{
					...
					if ((flags & 2) != 0)
					{
						short dx = (short)(points.GetAndIncrease());
				...
				for (i = (int)(0); (i) < (n); ++i)
				{
					...
					if ((flags & 4) != 0)
					{
						short dy = (short)(points.GetAndIncrease());
				...
				for (i = (int)(0); (i) < (n); ++i)
				{
					...
					if ((next_move) == (i))
					{
						...
						stbtt_setvertex(ref vertices[num_vertices++], (byte)(STBTT_vmove), (int)(sx), (int)(sy), (int)(0), (int)(0));
						was_off = (int)(0);
					...
					else
					{
						...
						{
							if ((was_off) != 0)
								stbtt_setvertex(ref vertices[num_vertices++], (byte)(STBTT_vcurve), (int)((cx + x) >> 1), (int)((cy + y) >> 1), (int)(cx), (int)(cy));
							cx = (int)(x);
							cy = (int)(y);
							was_off = (int)(1);
						}
						...
						{
							if ((was_off) != 0)
								stbtt_setvertex(ref vertices[num_vertices++], (byte)(STBTT_vcurve), (int)(x), (int)(y), (int)(cx), (int)(cy));
							else
								stbtt_setvertex(ref vertices[num_vertices++], (byte)(STBTT_vline), (int)(x), (int)(y), (int)(0), (int)(0));
							was_off = (int)(0);
						}
					}
				}
			...
			else if ((numberOfContours) < (0))
			{
				...
				while ((more) != 0)
				{
					...
					comp_num_verts = (int)(stbtt_GetGlyphShape(info, (int)(gidx), out comp_verts));
					if ((comp_num_verts) > (0))
					{
						for (i = (int)(0); (i) < (comp_num_verts); ++i)
						{
							short x = 0;
							short y = 0;
							x = (short)(comp_verts[i].x);
							y = (short)(comp_verts[i].y);
							comp_verts[i].x = ((short)(m * (mtx[0] * x + mtx[2] * y + mtx[4])));
							comp_verts[i].y = ((short)(n * (mtx[1] * x + mtx[3] * y + mtx[5])));
							x = (short)(comp_verts[i].cx);
							y = (short)(comp_verts[i].cy);
		...
		public static stbtt__buf stbtt__cid_get_glyph_subrs(stbtt_fontinfo info, int glyph_index)
		{
			...
			if ((fdselector) == (-1))
				stbtt__new_buf(FakePtr<byte>.Null, (ulong)(0));
		...
		{
			if (info.cff.size == 0)
				return (int)(stbtt__GetGlyphShapeTT(info, (int)(glyph_index), out pvertices));
			else
				return (int)(stbtt__GetGlyphShapeT2(info, (int)(glyph_index), out pvertices));
		}
		...
		public static void stbtt_GetCodepointHMetrics(stbtt_fontinfo info, int codepoint, ref int advanceWidth, ref int leftSideBearing)
		{
			stbtt_GetGlyphHMetrics(info, (int)(stbtt_FindGlyphIndex(info, (int)(codepoint))), ref advanceWidth, ref leftSideBearing);
		}
		...
		public static int stbtt_GetFontVMetricsOS2(stbtt_fontinfo info, ref int typoAscent, ref int typoDescent, ref int typoLineGap)
		{
		...
		public static FakePtr<byte> stbtt_FindSVGDoc(stbtt_fontinfo info, int gl)
		{
			int i = 0;
			FakePtr<byte> data = info.data;
			FakePtr<byte> svg_doc_list = data + stbtt__get_svg(info);
			int numEntries = (int)(ttUSHORT(svg_doc_list));
			FakePtr<byte> svg_docs = svg_doc_list + 2;
			for (i = (int)(0); (i) < (numEntries); i++)
			{
				FakePtr<byte> svg_doc = svg_docs + (12 * i);
		...
		public static int stbtt_GetGlyphSVG(stbtt_fontinfo info, int gl, ref FakePtr<byte> svg)
		{
			...
			if (!svg_doc.IsNull)
			{
				svg = (FakePtr<byte>)(data) + info.svg + ttULONG(svg_doc + 4);
		...
		{
			return (int)(stbtt_GetGlyphSVG(info, (int)(stbtt_FindGlyphIndex(info, (int)(unicode_codepoint))), ref svg));
		}

		public static void stbtt_GetGlyphBitmapBoxSubpixel(stbtt_fontinfo font, int glyph, float scale_x, float scale_y, float shift_x, float shift_y, ref int ix0, ref int iy0, ref int ix1, ref int iy1)
		{
			int x0 = (int)(0);
			int y0 = (int)(0);
			int x1 = 0;
			...
			{
				ix0 = ((int)(Math.Floor((double)(x0 * scale_x + shift_x))));
				iy0 = ((int)(Math.Floor((double)(-y1 * scale_y + shift_y))));
				ix1 = ((int)(Math.Ceiling((double)(x1 * scale_x + shift_x))));
				iy1 = ((int)(Math.Ceiling((double)(-y0 * scale_y + shift_y))));
			}
		}

		public static void stbtt_GetGlyphBitmapBox(stbtt_fontinfo font, int glyph, float scale_x, float scale_y, ref int ix0, ref int iy0, ref int ix1, ref int iy1)
		{
			stbtt_GetGlyphBitmapBoxSubpixel(font, (int)(glyph), (float)(scale_x), (float)(scale_y), (float)(0.0f), (float)(0.0f), ref ix0, ref iy0, ref ix1, ref iy1);
		}

		public static void stbtt_GetCodepointBitmapBoxSubpixel(stbtt_fontinfo font, int codepoint, float scale_x, float scale_y, float shift_x, float shift_y, ref int ix0, ref int iy0, ref int ix1, ref int iy1)
		{
			stbtt_GetGlyphBitmapBoxSubpixel(font, (int)(stbtt_FindGlyphIndex(font, (int)(codepoint))), (float)(scale_x), (float)(scale_y), (float)(shift_x), (float)(shift_y), ref ix0, ref iy0, ref ix1, ref iy1);
		}

		public static void stbtt_GetCodepointBitmapBox(stbtt_fontinfo font, int codepoint, float scale_x, float scale_y, ref int ix0, ref int iy0, ref int ix1, ref int iy1)
		{
			stbtt_GetCodepointBitmapBoxSubpixel(font, (int)(codepoint), (float)(scale_x), (float)(scale_y), (float)(0.0f), (float)(0.0f), ref ix0, ref iy0, ref ix1, ref iy1);
		}

		public static FakePtr<byte> stbtt_GetGlyphBitmapSubpixel(stbtt_fontinfo info, float scale_x, float scale_y, float shift_x, float shift_y, int glyph, ref int width, ref int height, ref int xoff, ref int yoff)
		{
			int ix0 = 0;
			int iy0 = 0;
			int ix1 = 0;
			...
			int num_verts = (int)(stbtt_GetGlyphShape(info, (int)(glyph), out vertices));
			if ((scale_x) == (0))
		...
		public static FakePtr<byte> stbtt_GetGlyphBitmap(stbtt_fontinfo info, float scale_x, float scale_y, int glyph, ref int width, ref int height, ref int xoff, ref int yoff)
		{
			return stbtt_GetGlyphBitmapSubpixel(info, (float)(scale_x), (float)(scale_y), (float)(0.0f), (float)(0.0f), (int)(glyph), ref width, ref height, ref xoff, ref yoff);
		}
		...
		public static FakePtr<byte> stbtt_GetCodepointBitmapSubpixel(stbtt_fontinfo info, float scale_x, float scale_y, float shift_x, float shift_y, int codepoint, ref int width, ref int height, ref int xoff, ref int yoff)
		{
			return stbtt_GetGlyphBitmapSubpixel(info, (float)(scale_x), (float)(scale_y), (float)(shift_x), (float)(shift_y), (int)(stbtt_FindGlyphIndex(info, (int)(codepoint))), ref width, ref height, ref xoff, ref yoff);
		}

		public static void stbtt_MakeCodepointBitmapSubpixelPrefilter(stbtt_fontinfo info, FakePtr<byte> output, int out_w, int out_h, int out_stride, float scale_x, float scale_y, float shift_x, float shift_y, int oversample_x, int oversample_y, ref float sub_x, ref float sub_y, int codepoint)
		{
			stbtt_MakeGlyphBitmapSubpixelPrefilter(info, output, (int)(out_w), (int)(out_h), (int)(out_stride), (float)(scale_x), (float)(scale_y), (float)(shift_x), (float)(shift_y), (int)(oversample_x), (int)(oversample_y), ref sub_x, ref sub_y, (int)(stbtt_FindGlyphIndex(info, (int)(codepoint))));
		}
		...
		public static FakePtr<byte> stbtt_GetCodepointBitmap(stbtt_fontinfo info, float scale_x, float scale_y, int codepoint, ref int width, ref int height, ref int xoff, ref int yoff)
		{
			return stbtt_GetCodepointBitmapSubpixel(info, (float)(scale_x), (float)(scale_y), (float)(0.0f), (float)(0.0f), (int)(codepoint), ref width, ref height, ref xoff, ref yoff);
		}
		...
		public static void stbtt_MakeGlyphBitmapSubpixelPrefilter(stbtt_fontinfo info, FakePtr<byte> output, int out_w, int out_h, int out_stride, float scale_x, float scale_y, float shift_x, float shift_y, int prefilter_x, int prefilter_y, ref float sub_x, ref float sub_y, int glyph)
		{
		...
		public static byte[] stbtt_GetGlyphSDF(stbtt_fontinfo info, float scale, int glyph, int padding, byte onedge_value, float pixel_dist_scale, ref int width, ref int height, ref int xoff, ref int yoff)
		{
			...
			scale_y = (float)(-scale_y);
			{
				...
				float[] precompute;
				stbtt_vertex[] verts;
				int num_verts = (int)(stbtt_GetGlyphShape(info, (int)(glyph), out verts));
				data = new byte[w * h];
					...
					for (x = (int)(ix0); (x) < (ix1); ++x)
					{
						...
						for (i = (int)(0); (i) < (num_verts); ++i)
						{
							...
							if ((verts[i].type) == (STBTT_vline))
							{
								...
								float dist = (float)((float)(Math.Abs((double)((x1 - x0) * (y0 - sy) - (y1 - y0) * (x0 - sx)))) * precompute[i]);
								if ((dist) < (min_dist))
								{
		...
		public static byte[] stbtt_GetCodepointSDF(stbtt_fontinfo info, float scale, int codepoint, int padding, byte onedge_value, float pixel_dist_scale, ref int width, ref int height, ref int xoff, ref int yoff)
		{
			return stbtt_GetGlyphSDF(info, (float)(scale), (int)(stbtt_FindGlyphIndex(info, (int)(codepoint))), (int)(padding), (byte)(onedge_value), (float)(pixel_dist_scale), ref width, ref height, ref xoff, ref yoff);
		}

		public static FakePtr<byte> stbtt_GetFontNameString(stbtt_fontinfo font, ref int length, int platformID, int encodingID, int languageID, int nameID)
		{
			int i = 0;
			int count = 0;
			int stringOffset = 0;
			...
			for (i = (int)(0); (i) < (count); ++i)
			{
				...
				if (((((platformID) == (ttUSHORT(fc + loc + 0))) && ((encodingID) == (ttUSHORT(fc + loc + 2)))) && ((languageID) == (ttUSHORT(fc + loc + 4)))) && ((nameID) == (ttUSHORT(fc + loc + 6))))
				{
					...
					return (FakePtr<byte>)(fc + stringOffset + ttUSHORT(fc + loc + 10));
				}
			}
			return FakePtr<byte>.Null;
		}
